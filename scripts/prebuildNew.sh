...
#tar xzvf ../depends/assimp-4.0.1-mod.tar.gz         -C ../ &
#tar xzvf ../depends/gdal-2.4.4-mod.tar.gz           -C ../ &
#tar xzvf ../depends/tinygltf-2.4.1-mod.tar.gz       -C ../takengine/thirdparty &
#tar xzvf ../depends/tinygltfloader-0.9.5-mod.tar.gz -C ../takengine/thirdparty &
#tar xzvf ../depends/libLAS-1.8.2-mod.tar.gz         -C ../ &
#tar xzvf ../depends/LASzip-3.4.3-mod.tar.gz         -C ../ &
#wait
